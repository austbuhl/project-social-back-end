class Friendship < ApplicationRecord
  ...
  def self.friend_request(user_id, friend_id)
    Friendship.find_or_create_by(user_id: user_id, friend_id: friend_id, status: 'pending', friender_id: user_id)
    Friendship.find_or_create_by(user_id: friend_id, friend_id: user_id, status: 'pending', friender_id: user_id)
  end
